...
- **Play view** — a big game clock, the last two steps you finished, the current step,
  the next two steps, the villager spread, and a drift indicator telling you how far
  behind the ideal timeline you are.
